...
namespace SchedCCS
{
    ...
    public static class DataManager
    {
        ...
        // Updated Programs List including Majors
        ...
        public static void Initialize()
        {
            LoadUsers();
            LoadRooms();
            LoadTeachers(); // UPDATED with your list
            LoadSections(); // UPDATED with new Program names
        }

        private static void LoadUsers()
        {
            Users.Add(new User { Username = "admin", Password = "123", Role = "Admin", FullName = "System Admin" });

            // Updated test account
            Users.Add(new User { Username = "0324-2227", Password = "1234", Role = "Student", StudentSection = "CS 2A", FullName = "Alezer Boyore" });
        }

        private static void LoadRooms()
        {
            // Lecture Rooms (Building A)
            for (int i = 1; i <= 15; i++)
                Rooms.Add(new Room { Id = i, Name = $"LEC {i}", Type = RoomType.Lecture });

            // Laboratory Rooms (Building B)
            for (int i = 1; i <= 8; i++)
        ...
        {
            // --- TEACHERS AND QUALIFIED SUBJECTS ---

            AddTeacher(1, "Mr. Desamero", "ITEC 102");
            AddTeacher(2, "Mr. Funtila", "GEC 103");
            AddTeacher(3, "Ms. Dela Torres", "ITEC 101", "ITEL 415");
            AddTeacher(4, "Ms. Cabreza", "GEC 102");
            AddTeacher(5, "Ms. Parica", "PE 1");
            AddTeacher(6, "Mr. Calosa", "GEC 101");
            AddTeacher(7, "Ms. Balinsayo", "KOMFIL");
            // TBA (ID 8) - GEC 104 handled dynamically or skipped
            AddTeacher(9, "Mr. Dorado", "ITEC 102", "ITEL 201", "CMSC 203", "ITST 301");
            AddTeacher(10, "Ms. Arida", "ITEC 101", "ITEC 104", "CMSC 307", "CAST 101");
            AddTeacher(11, "Mr. Sael", "PE 1");
            AddTeacher(12, "Mr. Agravante", "PI 100");
            AddTeacher(13, "Ms. Encanto", "ITEC 204");
            AddTeacher(14, "Ms. Escote", "ITEL 201", "ITEL 203", "ITEP 203"); // Added ITEP 203 based on schedule
            ...
            AddTeacher(28, "Mr. Andres", "ITEL 304", "ITEL 202"); // Added ITEL 202 based on schedule
            AddTeacher(29, "Mr. Ual", "ITEL 308", "ITEP 415", "ITEL 414", "ITEP 308", "ITEP 414"); // Added extras from schedule
            ...
            AddTeacher(35, "Mr. Amora", "CSST 101", "ITST 306", "ITEC 205"); // Added ITEC 205
            AddTeacher(36, "Engr. Santos", "ITEL 413", "ITEP 413"); // Added ITEP 413
            AddTeacher(37, "Mr. Dela Cruz", "ITEP 415", "ITST 306");
        }

        // Helper to add teacher cleanly
        ...
        private static void CreateSection(string name, string program, int year, (string, string)[] subjects)
        {
            ...
            foreach (var subj in subjects)
            {
                ...
                // Ensure teacher has this subject (Safety Check)
                var teacher = Teachers.FirstOrDefault(t => t.Name.ToUpper() == teacherName.ToUpper());
                if (teacher != null)
                {
        ...
        {
            // ==========================================
            // 1ST YEAR - BSINFO (Was INFO)
            // ==========================================
            var info1Subjs = new[] {
                ("ITEC 102", "Mr. Desamero"), ("GEC 103", "Mr. Funtila"), ("ITEC 101", "Ms. Dela Torres"),
            ...
            CreateSection("CS BA", "BSCS", 2, cs2Subjs);
            ...
            var wmad3Subjs = new[] {
                ...
                ("ITST 301", "Mr. Dorado"), ("ITST 302", "Ms. Viojan"), ("ITEP 309", "Ms. Viojan")
            };
            CreateSection("3WMAD1", "WMAD", 3, wmad3Subjs);
            CreateSection("3WMAD2", "WMAD", 3, wmad3Subjs);

            CreateSection("3WMAD3", "WMAD", 3, new[] {
                ("ITEP 308", "Mr. Manaloto"), ("ITEP 310", "Ms. Espinueva"), ("ITEL 304", "Mr. Del Rosario"),
                ("ITST 301", "Mr. Dorado"), ("ITST 302", "Ms. Viojan"), ("ITEP 309", "Ms. Viojan")
            });
            ...
            // 3RD YEAR - SMP & NA
            // ==========================================
            CreateSection("3SMP1", "SMP", 3, new[] {
                ("ITST 302", "Mr. Manzanero"), ("ITEL 304", "Mr. Andres"), ("ITEP 308", "Mr. Manaloto"),
                ("ITEP 310", "Mr. Manzanero"), ("ITST 301", "Ms. Espinueva"), ("ITEP 309", "Mr. Ual")
            });

            var na3Subjs = new[] {
                ("ITEL 304", "Mr. Andres"), ("ITEP 308", "Mr. Ual"), ("ITEP 309", "Ms. Viojan"),
                ("ITST 302", "Engr. De Luna"), ("ITEP 310", "Mr. Manzanero"), ("ITST 301", "Engr. De Luna")
            };
            CreateSection("3NA1", "NA", 3, na3Subjs);
            CreateSection("3NA2", "NA", 3, na3Subjs);

            // ==========================================
            // 3RD YEAR - IS & GAV
            // ==========================================
            var is3Subjs = new[] {
                ("CMSC 310", "Mr. Ilagan"), ("CMSC 309", "Ms. Castillo"), ("CSST 102", "Mr. Villareal"),
                ("CMSC 305", "Ms. Ompangco"), ("CMSC 306", "Ms. Cabuyao"), ("CSST 101", "Mr. Amora"),
                ("CMSC 308", "Ms. Ompangco"), ("CMSC 307", "Ms. Arida")
            };
            CreateSection("3IS1", "IS", 3, is3Subjs);
            CreateSection("3IS2", "IS", 3, is3Subjs);

            CreateSection("3GAV1", "GAV", 3, new[] {
                ("CMSC 305", "Ms. Ompangco"), ("CMSC 309", "Ms. Castillo"), ("CMSC 310", "Mr. Ilagan"),
                ("CSST 102", "Mr. Lara"), ("CSST 101", "Ms. Arida"), ("CMSC 306", "Ms. Cabuyao"),
                ("CMSC 307", "Ms. Arida"), ("CMSC 308", "Ms. Ompangco")
            });
            ...
            // ==========================================
            var wmad4Subjs = new[] {
                ("ITEP 413", "Engr. Santos"), ("ITST 306", "Mr. Amora"), ("ITEP 414", "Mr. Ual"),
                ("ITEP 415", "Ms. Dela Torres")
            };
            CreateSection("4WMAD3", "WMAD", 4, wmad4Subjs);

            CreateSection("4WMAD2", "WMAD", 4, new[] {
                ("ITEP 413", "Engr. Santos"), ("ITST 306", "Ms. Cabuyao"), ("ITEP 414", "Mr. Ual"),
                ("ITEP 415", "Mr. Dela Cruz")
            });
            CreateSection("4WMAD1", "WMAD", 4, new[] {
                ("ITEP 413", "Engr. Santos"), ("ITST 306", "Ms. Encanto"), ("ITEP 414", "Mr. Ual"),
                ("ITEP 415", "Mr. Dela Cruz")
            });

            CreateSection("4SMP1", "SMP", 4, new[] {
                ("ITEP 413", "Engr. Santos"), ("ITEP 414", "Mr. Ual"), ("ITEP 415", "Ms. Dela Torres"),
                ("ITST 306", "Mr. Manzanero")
            });
            CreateSection("4SMP2", "SMP", 4, new[] {
                ("ITEP 413", "Engr. Santos"), ("ITEP 414", "Mr. Ual"), ("ITEP 415", "Ms. Dela Torres"),
                ("ITST 306", "Mr. Dela Cruz")
            });
